...
Full-Stack Data Analysis to build an interactive dashboard exploring the Belly Button Biodiversity Dataset using Plotly.js, Flask 

## Objectives


### Step 1 - CleanJson.ipynb

* Use panda to clean Json data to metadata.csv and samples.csv. after clean everything save to sqlite as belly_button.sqlite. connect with sqlite from flask create_engine to pull out datas.
